<?php
    ...
    if(isset($_POST['submit'])){
        ...
        if(empty($title)||empty($amount)||empty($date)){
            ...
            mysqli_query($conn,"INSERT INTO income(amount,title,date,recurring,userID,category) VALUES($amount,'$title','$date','$isRecurring','$userID','$category')");
...
<body>
    <div class="addIncome">
        <h1 class="mainTitle">Add New Income</h1>
        <div class="addGrid">
            <form class="grid" method="post">
                ...
                <div class="addCategory">
                    ...
                    <select class="category" name="category" id="category">
                        ...
                        <option value="Allowance/Gifts">Allowance/Gifts</option>
