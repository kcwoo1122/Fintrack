<?php
    ...
    $getVideos=mysqli_query($conn,"SELECT * FROM video");
    ...
    if(isset($_POST['search'])){
        ...
        $getVideos=mysqli_query($conn,"SELECT * FROM video WHERE title='$title'");
    }

    if(isset($_POST['categorySearch'])){
        $category=$_POST['category'];
        $getVideos=mysqli_query($conn,"SELECT * FROM video WHERE category='$category'");
    }
...
<body>
    <h2 class="pageTitle">Search Videos</h2>
    <form method="post">
        <div class="top">
