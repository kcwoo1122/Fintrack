<?php
    ...
    $getCategories=mysqli_query($conn,"SELECT DISTINCT category FROM income WHERE userID=$userID");
    $errmsg='';
    ...
    if(isset($_POST['submit'])){
        ...
        if(empty($startDate)||empty($endDate)){
            ...
            mysqli_query($conn,"INSERT INTO incomechart(chartType,startDate,endDate,userID,category) VALUES('$chartType','$startDate','$endDate',$userID,'$category')");
