...
<body>
    <div class="sidebar">
        ...
        <div onclick="window.location.href='manageUsers.php'" class="shortcut"  id="income"><i class="fa-solid fa-wallet"></i>&nbsp&nbsp&nbspManagement</div>
        <div onclick="window.location.href='approvals.php'" class="shortcut"  id="expenses"><i class="fa-solid fa-money-bill"></i>&nbsp&nbsp&nbspApprovals</div>
